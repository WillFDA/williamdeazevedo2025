...
export default function Footer() {
  return (
    <footer className="w-full border-gray-100 border-t bg-gradient-to-b from-gray-50/50 to-white">
      <div className="mx-auto max-w-2xl px-4 py-12">
        ...
        <div className="mb-8 flex flex-col items-center gap-4 text-center">
          ...
          <a
            className="inline-flex h-10 shrink-0 items-center justify-center gap-2 whitespace-nowrap rounded-md border-gray-900 bg-gray-900 px-5 font-medium text-sm text-white outline-none transition-all hover:bg-gray-800 focus-visible:border-ring focus-visible:ring-[3px] focus-visible:ring-ring/50 disabled:pointer-events-none disabled:opacity-50 [&_svg:not([class*='size-'])]:size-4 [&_svg]:pointer-events-none [&_svg]:shrink-0"
        ...
        <div className="flex flex-col-reverse items-center gap-6 lg:flex-row lg:justify-between">
          ...
          <div className="flex flex-col items-center gap-4 lg:items-end">
            <div className="flex items-center gap-4">
              ...
              <a aria-label="Email" href="mailto:william.ferreirapro@gmail.com">
